...
--main-- 
SELECT AVG(longterm_profit::numeric)::money AS play_avg_profit
FROM play_profit_info 
WHERE play_profit_info.name NOT IN (SELECT DISTINCT name FROM common_apps)
